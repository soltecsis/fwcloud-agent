...
pub fn routes_setup(config: &mut web::ServiceConfig) {
    config.service(
        web::scope("/api/v1")
            ...
            .service(info::info)
            // CrowdSec.
            .service(crowdsec::preflight_crowdsec_transition)
            .service(crowdsec::prepare_crowdsec_transition)
            .service(crowdsec::activate_crowdsec_transition)
            .service(crowdsec::crowdsec_transition)
            .service(crowdsec::recover_crowdsec_transition)
            .service(crowdsec::finalize_crowdsec_transition)
            ...
            .service(crowdsec::export_crowdsec_machine_credentials)
            .service(crowdsec::replicate_crowdsec_lapi_machine)
            .service(crowdsec::validate_crowdsec_lapi_machine)
            .service(crowdsec::activate_crowdsec_remote_machine)
            .service(crowdsec::reauthenticate_crowdsec_remote_machine)
            .service(crowdsec::resume_crowdsec_remote_machine)
