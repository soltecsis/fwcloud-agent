...
lazy_static! {
  ...
  pub static ref PLUGINS_NAMES: Regex = Regex::new("^(test|openvpn|geoip|crowdsec|ntopng|suricata|keepalived|zeek|elasticsearch|filebeat|websafetyproxy|kibana|logstash)$").unwrap();
